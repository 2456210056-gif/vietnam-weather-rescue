  ...
  return (
    <AuthShell mode="login">
      <div className="mb-7 text-center lg:text-left">
        <div className="mx-auto mb-4 grid h-12 w-12 place-items-center rounded-2xl bg-blue-50 text-blue-600 lg:mx-0">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <label className="block">
          ...
          <div className="mt-2 flex h-12 items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 transition focus-within:border-blue-400 focus-within:bg-white focus-within:ring-4 focus-within:ring-blue-100">
        ...
        <button
          className="gpu-transition h-12 w-full rounded-2xl bg-gradient-to-r from-blue-600 to-emerald-500 px-4 text-base font-black text-white shadow-lg shadow-blue-950/15 transition hover:from-blue-500 hover:to-emerald-400 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
          disabled={loading}
          type="submit"
        >
      ...
      {enabledOAuthProviders.google || enabledOAuthProviders.facebook ? (
        <>
          <div className="my-5 flex items-center gap-3 text-xs font-black uppercase tracking-[0.16em] text-slate-400">
          ...
          <div className="grid gap-3">
            {enabledOAuthProviders.google ? (
              <button
                className="h-12 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-black text-slate-900 shadow-sm transition duration-200 hover:bg-slate-50 active:scale-[0.98]"
